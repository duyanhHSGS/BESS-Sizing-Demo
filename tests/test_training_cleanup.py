    ...
    def test_fit_command_forwards_all_generic_ppo_ui_tunables(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            payload = {
                ...
                "lambda": 0.97,
                "learning_rate": 2e-4,
                "exploration_lr_multiplier": 7.5,
                "soc_edge_log_std_penalty": 0.25,
                "ppo_clip": 0.15,
                "ppo_epochs": 3,
                "minibatch": 64,
                "entropy_coef": 0.02,
                ...
                "oracle_actor_bc_max_epochs": 155,
        ...
        expected_values = {
            ...
            "--exploration-lr-multiplier": "7.5",
            "--soc-edge-log-std-penalty": "0.25",
            "--ppo-clip": "0.15",
            "--ppo-epochs": "3",
            "--minibatch": "64",
            "--entropy-coef": "0.02",
            ...
            "--oracle-actor-bc-max-epochs": "155",

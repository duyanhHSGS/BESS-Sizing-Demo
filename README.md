...
lp_core.py              → Linear Programming solver core (the math department 🧮)
sadrbc.py               → SADRBC v13 rule-based controller (the veteran uncle 👴)
oracle_cache.py         → Caches LP oracle results (the short-term memory 🗃️)
oracle_lp.py            → LP oracle wrapper (the perfect-foresight wizard 🔮)

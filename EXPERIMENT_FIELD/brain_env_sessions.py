"""Temporary Flask-facing sessions for the isolated BrainEnv playground.

This module deliberately does not connect BrainEnv to training, checkpoints,
dispatch, or persistent run storage.  A session snapshots one selected CSV day
and the currently applied UI economics, then advances only through BrainEnv.step().
"""
...
from EXPERIMENT_FIELD.brain_env import BrainEnv, ElectricityMeterState

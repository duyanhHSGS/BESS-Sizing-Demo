    ...
    for day, dispatch in zip(month.days, oracle_dispatch, strict=True):
        ...
        for start in range(0, native_rows, native_steps):
            ...
            transition = step_brain_control(
                ...
                elastic_peak_bid_enabled=PPO_ELASTIC_PEAK_BID_ENABLED,
                elastic_peak_reserve_fraction=PPO_ELASTIC_PEAK_RESERVE_FRACTION,
                elastic_peak_reserve_release_start_hour=PPO_ELASTIC_PEAK_RESERVE_RELEASE_START_HOUR,
                elastic_peak_reserve_release_end_hour=PPO_ELASTIC_PEAK_RESERVE_RELEASE_END_HOUR,
...
def main() -> None:
    ...
    # IQ-63's two-bucket jury beat IQ-62 on the untouched test bucket; IQ-65
    # restores that exact 8/2/1 split after rejecting IQ-64 demand weighting.
    # TODO(IQ-65): keep this measured split fixed for the restoration baseline.
    ...
    agent.meta = {
        ...
        "peak_guard_mode": "causal_history_elastic_soc_bid_v5",
        "peak_guard_min_completed_days": PPO_PEAK_GUARD_MIN_COMPLETED_DAYS,

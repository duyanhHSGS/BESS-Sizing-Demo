...
PPO2_CONTROL_NATIVE_STEPS = PPO2_DEMAND_BLOCK_SLOTS
PPO2_CONTROL_DT_MINUTES = PPO2_DT_HOURS * 60.0 * PPO2_CONTROL_NATIVE_STEPS
PPO2_DECISIONS_PER_DAY = PPO2_STEPS_PER_DAY // PPO2_CONTROL_NATIVE_STEPS
PPO2_OBS_DIM = 17

PPO2_GAMMA = 1.0
PPO2_LAM_ENERGY = 0.97
PPO2_LAM_PEAK = 0.97
# TODO(PPO2-30M): keep rollout measured in policy decisions so one update still spans ~30 days.
ROLLOUT = PPO2_DECISIONS_PER_DAY * 30
